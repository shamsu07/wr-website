...
import wrLogo from "../../public/images/footer/footer-logo.svg";

const Footer = () => {
  return (
    <footer
      className="wow fadeInUp relative z-10 bg-blueSapphire pt-5 lg:pt-[50px]"
      data-wow-delay=".15s"
    >
          ...
          <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-2 text-sm text-opal">
                ...
                <br />
                1701 B, 17th floor, One International Centre, Senapati Bapat
                Marg, Prabhadevi west, Mumbai, 400013
              </p>
            </div>
          </div>
      ...
      <div className="mt-12 border-t border-[#8890A4] border-opacity-40 py-4 lg:mt-[20px]">
